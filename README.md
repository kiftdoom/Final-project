...
![Development Process](https://example.com/development-process.gif) <!-- Ejemplo de GIF animado -->
...
## ⚙️ Functional and Non-Functional Elements of the Project
...
- **Adaptability**: The agile methodology allowed for rapid adaptation to changes and project needs, highlighting the importance
